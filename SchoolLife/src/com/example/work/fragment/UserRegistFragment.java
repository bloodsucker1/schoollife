...
public class UserRegistFragment extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater,
		...
		tv_phone.setText("用户名注册");
		btn_phone.setText("立即注册");
		right_image_btn.setText("手机号注册");
		et_phone_co_password.setVisibility(View.VISIBLE);
		froget_pass.setVisibility(View.GONE);
...
//			((PersonInfoActiviy) getActivity()).startFrgment(new PersonRegistFragment());
			break;
		case R.id.btn_phone:
